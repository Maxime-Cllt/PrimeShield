...
\begin{document}
    ...
    \begin{lstlisting}[caption={Fonction exponentiation rapide modulaire (Rust)}, label={lst:rust_exponential_fast_mod}]
...
\lstset{language=Rust}
\begin{lstlisting}[caption={Fonction de test de primalité (Rust)}, label={lst:rust_exponential_fast_mod}]
